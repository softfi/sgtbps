...
public class StudentSubjectAttendenceAdapter extends RecyclerView.Adapter<StudentSubjectAttendenceAdapter.MyViewHolder> {
    ...
    private com.sgtbps.students.StudentAttendance context;
    ...
    public StudentSubjectAttendenceAdapter(com.sgtbps.students.StudentAttendance studentExamSchedule, ArrayList<String> subjectList, ArrayList<String> timeList, ArrayList<String> roomList, ArrayList<String> typeList, ArrayList<String> remarkList) {
