...
import com.sgtbps.AboutSchool;
import com.sgtbps.Login;
import com.sgtbps.fragments.DashboardFragment;
import com.sgtbps.fragments.StudentDashboardNotice;
import com.sgtbps.R;
import com.sgtbps.adapters.LoginChildListAdapter;
import com.sgtbps.utils.Constants;
import com.sgtbps.utils.DatabaseHelper;
...
public class StudentDashboard extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.navigation_homework:
                        loadFragment(new com.sgtbps.fragments.StudentDashboardHomeWork());
                        drawer.closeDrawer(GravityCompat.START);
                        return true;

                    case R.id.navigation_fees:
                        loadFragment(new com.sgtbps.fragments.StudentDashboardFees());
                        drawer.closeDrawer(GravityCompat.START);
                        return true;
                    ...
                    case R.id.navigation_reportCard:
                        loadFragment(new com.sgtbps.fragments.StudentDashboardReportCard());
                        drawer.closeDrawer(GravityCompat.START);
                        return true;
                }
                return false;
    ...
    private void setUpDrawer() {
        ...
        drawerArrowDrawable = new com.sgtbps.utils.DrawerArrowDrawable(resources);
    ...
    private void decorate() {
        ...
        Picasso.with(getApplicationContext()).load(Utility.getSharedPreferences(this, "userImage")).placeholder(R.drawable.user).into(profileImageIV);
        //Picasso.with(getApplicationContext()).load(appLogo).memoryPolicy(MemoryPolicy.NO_CACHE).networkPolicy(NetworkPolicy.NO_CACHE).into(actionBarLogo);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_onlineexam:
                        Intent onlineexam = new Intent(StudentDashboard.this, com.sgtbps.students.StudentOnlineExam.class);
                    ...
                    case R.id.nav_downloadCenter:
                        Intent download = new Intent(StudentDashboard.this, com.sgtbps.students.StudentDownloads.class);
                    ...
                    case R.id.nav_attendance:
                        Intent attendance = new Intent(StudentDashboard.this, com.sgtbps.students.StudentAttendance.class);
                    ...
                    case R.id.nav_examination:
                        Intent examination = new Intent(StudentDashboard.this, com.sgtbps.students.StudentExaminationList.class);
                    ...
                    case R.id.nav_timeLine:
                        Intent timeline = new Intent(StudentDashboard.this, com.sgtbps.students.StudentTimeline.class);
                    ...
                    case R.id.nav_documents:
                        Intent doc = new Intent(StudentDashboard.this, com.sgtbps.students.StudentDocuments.class);
                        startActivity(doc);
                        overridePendingTransition(R.anim.slide_leftright, R.anim.no_animation);
                        drawer.closeDrawer(GravityCompat.START);
                        break;
