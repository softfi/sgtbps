...
public class StudentCoursePerAdapter extends RecyclerView.Adapter<StudentCoursePerAdapter.MyViewHolder> {
    ...
    private com.sgtbps.students.StudentCoursePerformance context;
    ...
    public StudentCoursePerAdapter(com.sgtbps.students.StudentCoursePerformance context, ArrayList<String> quiz_titleList, ArrayList<String> idList, ArrayList<String> correct_answerList, ArrayList<String> wrong_answerList,
    ...
    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewTypnotepe) {
