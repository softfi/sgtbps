...
import com.sgtbps.R;
import com.sgtbps.students.StudentExamSchedule;
...
public class StudentExamScheduleAdapter extends RecyclerView.Adapter<StudentExamScheduleAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.subjectNameHeader.setBackgroundColor(Color.parseColor(Utility.getSharedPreferences(context, Constants.secondaryColour)));
