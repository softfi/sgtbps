...
import com.sgtbps.R;
import com.sgtbps.adapters.CourseCurriculumAdapterNew;
import com.sgtbps.model.LessonModel;
...
public class StudentCourseDetail  extends com.sgtbps.BaseActivity {
   ...
   TextView courseDescription;
    ...
    String url;
    ArrayList<com.sgtbps.model.SectionModel> sectionList = new ArrayList<>();
    @Override
                ...
                if(Courseprogress.equals("0")){
                    if(Coursepaidlist.equals("1")){
                        ...
                        buy_now_btn.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Intent intent=new Intent(getApplicationContext(), com.sgtbps.students.CoursePayment.class);
                                intent.putExtra("CourseId",CourseId);
                                startActivity(intent);
                            }
                        });
                ...
                if (result != null) {
                    ...
                    try{
                        ...
                        for (int j = 0; j<dataArray.length(); j++) {
                            com.sgtbps.model.SectionModel sectionrModel = new com.sgtbps.model.SectionModel();
